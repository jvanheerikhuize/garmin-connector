...
- Create a new markdown file in `specs/adrs/` following the sequential naming convention (e.g., `0003-use-sqlite.md`).
...
- Open `specs/tech-stack.md`.
- Update the table to reflect the newly chosen technology, linking to the new ADR.

## Step 4: Application Code Regeneration
- If this decision changes existing implementation details (e.g., switching databases or programming languages), trigger `specs/workflows/regeneration.md` to align the codebase with the newly chosen architecture.
