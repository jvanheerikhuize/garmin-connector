...
Read-only discovery of connected Garmin watches across Linux, Windows, and macOS filesystem mounts, without requiring the user to know or supply a mount path. This is the sensing half of the walking skeleton: without it, nothing else in the app can know a watch exists.
